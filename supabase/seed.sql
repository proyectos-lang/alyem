...
-- Usuarios (sin AUTH; el selector de la barra superior elige el activo) -------
insert into usuarios (id, empresa_id, nombre, email, rol) values
  ('20000000-0000-0000-0000-000000000001', null, 'Ana Robles (Admin)',        'admin@agenciaduanera.hn',   'admin'),
  ('20000000-0000-0000-0000-000000000002', null, 'Carlos Méndez (Operador)',  'carlos@agenciaduanera.hn',  'operador'),
  ('20000000-0000-0000-0000-000000000003', null, 'Diana Fuentes (Operador)',  'diana@agenciaduanera.hn',   'operador'),
  ('20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', 'Luis Portillo',   'luis@importadoravalle.hn', 'cliente'),
  ('20000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', 'María Cálix',     'maria@importadoravalle.hn','cliente'),
  ('20000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000002', 'Jorge Almendárez','jorge@comercialpacifico.hn','cliente');
...
insert into cuentas_bancarias (id, banco, numero, titular, moneda, instrucciones) values
  ('60000000-0000-0000-0000-000000000001', 'Banco Atlántida', '0110-023-456789', 'Agencia Aduanera Robles S.A.', 'HNL', 'Cuenta de ahorro. Enviar comprobante al reportar el pago.'),
  ('60000000-0000-0000-0000-000000000002', 'Banco Ficohsa',   '2001-556677-USD', 'Agencia Aduanera Robles S.A.', 'USD', 'Cuenta en dólares para flete e impuestos en USD.');

-- Configuración --------------------------------------------------------------
insert into configuracion (clave, valor, descripcion) values
  ('agencia_nombre',        'Agencia Aduanera Robles',        'Nombre mostrado en la app y reportes PDF'),
