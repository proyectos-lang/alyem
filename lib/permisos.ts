...
export const PERMISOS = {
  ...
  LIQUIDACION_EDITAR: "liquidacion.editar",
  PAGO_REPORTAR: "pago.reportar",
  PAGO_VERIFICAR: "pago.verificar",
...
export const PERMISOS_META: { clave: ClavePermiso; etiqueta: string; grupo: string }[] = [
  ...
  { clave: PERMISOS.EVENTO_REGISTRAR, etiqueta: "Registrar eventos", grupo: "Gestiones" },
  ...
  { clave: PERMISOS.LIQUIDACION_EDITAR, etiqueta: "Crear/editar liquidaciones", grupo: "Finanzas" },
  { clave: PERMISOS.PAGO_REPORTAR, etiqueta: "Reportar pagos", grupo: "Finanzas" },
  { clave: PERMISOS.PAGO_VERIFICAR, etiqueta: "Verificar pagos", grupo: "Finanzas" },
  { clave: PERMISOS.MENSAJE_ENVIAR, etiqueta: "Enviar mensajes", grupo: "Colaboración" },
  { clave: PERMISOS.COTIZACION_CREAR, etiqueta: "Solicitar cotizaciones", grupo: "Negocio" },
  { clave: PERMISOS.COTIZACION_RESPONDER, etiqueta: "Responder cotizaciones", grupo: "Negocio" },
  { clave: PERMISOS.CALIFICACION_CREAR, etiqueta: "Calificar el servicio", grupo: "Negocio" },
...
const DEFAULTS: Record<Rol, ClavePermiso[]> = {
  ...
  operador: [
    ...
    P.DOCUMENTO_REVISAR,
    P.LIQUIDACION_EDITAR,
    P.PAGO_VERIFICAR,
    P.MENSAJE_ENVIAR,
    P.COTIZACION_RESPONDER,
    P.REPORTES_VER,
  ],
