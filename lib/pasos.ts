...
export const PASOS: Paso[] = [
  ...
  },
  {
    ...
    campos: [
      ...
      { name: "modelo", label: "Modelo", tipo: "text" },
      ...
      { name: "carta_porte", label: "Carta de porte (DUCA T)", tipo: "text" },
    ],
  },
  {
  ...
  },
  {
    ...
    campos: [
      ...
      { name: "tiempo_libre_dias", label: "Tiempo libre (días)", tipo: "num" },
      { name: "fecha_fin_dias_libres", label: "Fin de días libres", tipo: "date" },
